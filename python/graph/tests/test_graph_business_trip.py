...
def test_graph_business_trip_1(graph_cities):
...
def test_graph_business_trip_2(graph_cities):
...
def test_graph_business_trip_3(graph_cities):
...
def test_graph_business_trip_4(graph_cities):
...
def test_graph_business_trip_5(graph_cities):
...
def test_graph_business_trip_6(graph_cities):

    #                           graph, [pandora, arendelle, monstroplolis, naboo, narnia, metroville, pandora]
    actual = graph_business_trip(
        graph_cities[0], [graph_cities[1], graph_cities[2], graph_cities[4], graph_cities[6], graph_cities[5], graph_cities[3], graph_cities[1]])
    expected = "True,$634"
